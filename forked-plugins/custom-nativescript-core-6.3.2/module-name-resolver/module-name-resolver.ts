import { ModuleListProvider, ModuleNameResolver as ModuleNameResolverDefinition } from ".";
import * as appCommonModule from "../application/application-common";
import { device, screen } from "../platform/platform";
...
import { findMatch, PlatformContext } from "./qualifier-matcher";
