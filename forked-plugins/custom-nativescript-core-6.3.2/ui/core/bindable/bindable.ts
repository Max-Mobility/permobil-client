...
import { categories as traceCategories, error as traceError, isCategorySet, isEnabled as traceEnabled, messageType as traceMessageType, notifyEvent as traceNotifyEvent, write as traceWrite } from "../../../trace";
...
export { Observable, WrappedValue, PropertyChangeData, EventData, traceEnabled, traceWrite, traceError, traceCategories, traceNotifyEvent, traceMessageType, isCategorySet };
