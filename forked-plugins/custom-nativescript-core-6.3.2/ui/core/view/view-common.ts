...
import { fromString as gestureFromString, GestureEventData, GesturesObserver, GestureTypes, observe as gestureObserve } from "../../gestures";
import { LinearGradient } from "../../styling/linear-gradient";
import { BackgroundRepeat, HorizontalAlignment, Length, PercentLength, VerticalAlignment, Visibility } from "../../styling/style-properties";
import { StyleScope } from "../../styling/style-scope";
import { Color, dip, Point, ShownModallyData, Size, View as ViewDefinition } from "../view";
import { booleanConverter, EventData, getEventOrGestureName, InheritedProperty, layout, Property, ShowModalOptions, traceCategories, traceEnabled, traceWrite, ViewBase } from "../view-base";
