  ...
  var DialogFragmentImpl = (function(_super) {
    ...
    DialogFragmentImpl.prototype.onStart = function() {
      ...
      if (this._fullscreen) {
        ...
        window_1.setBackgroundDrawable(
...
var View = (function(_super) {
  ...
  View.prototype.on = function(eventNames, callback, thisArg) {
    ...
    var isLayoutEvent =
      typeof eventNames === 'string'
        ? eventNames.indexOf(view_common_1.ViewCommon.layoutChangedEvent) !== -1
        : false;
  ...
  View.prototype.off = function(eventNames, callback, thisArg) {
    ...
    if (
      ...
      isLayoutEvent &&
      !this.hasListeners(view_common_1.ViewCommon.layoutChangedEvent)
    ) {
  ...
  View.prototype.hasGestureObservers = function() {
    return (
      this._gestureObservers && Object.keys(this._gestureObservers).length > 0
    );
  };
  ...
  View.prototype.getLocationRelativeTo = function(otherView) {
    ...
    return {
      x: view_common_1.layout.toDeviceIndependentPixels(
        myArray[0] - otherArray[0]
      ),
      y: view_common_1.layout.toDeviceIndependentPixels(
        myArray[1] - otherArray[1]
      )
    };
  };
  View.resolveSizeAndState = function(
    ...
    return (
      result | (childMeasuredState & view_common_1.layout.MEASURED_STATE_MASK)
    );
  };
  View.prototype._showNativeModalView = function(parent, options) {
    ...
    if (options.android && options.android.cancelable !== undefined) {
      ...
      console.log(
        'ShowModalOptions.android.cancelable is deprecated. Use ShowModalOptions.cancelable instead.'
      );
    }
    cancelable =
  ...
  View.prototype[
    ...
    switch (nativeVisibility) {
      ...
      default:
        throw new Error(
          'Unsupported android.view.View visibility: ' +
            nativeVisibility +
            '. Currently supported values are android.view.View.VISIBLE, android.view.View.INVISIBLE, android.view.View.GONE.'
        );
    }
  };
      ...
      default:
        throw new Error(
          'Invalid visibility value: ' +
            value +
            '. Valid values are: visible, hidden, collapse.'
        );
    }
  };
  ...
  View.prototype[
    style_properties_1.androidElevationProperty.getDefault
  ] = function() {
    return this.getDefaultElevation();
  };
  View.prototype[
    style_properties_1.androidElevationProperty.setNative
  ] = function(value) {
    if (sdkVersion() < 21) {
      return;
    }
  ...
  View.prototype[
    style_properties_1.androidDynamicElevationOffsetProperty.getDefault
  ] = function() {
    return this.getDefaultDynamicElevationOffset();
  };
  View.prototype[
    style_properties_1.androidDynamicElevationOffsetProperty.setNative
  ] = function(value) {
    if (sdkVersion() < 21) {
      return;
    }
  ...
  View.prototype.getDefaultElevation = function() {
    ...
    return view_common_1.layout.toDeviceIndependentPixels(
      this.nativeViewProtected.getElevation()
    );
  };
  ...
  View.prototype.refreshStateListAnimator = function() {
    ...
    pressedSet.playTogether(
      java.util.Arrays.asList([
        ObjectAnimator.ofFloat(nativeView, 'translationZ', [
          pressedZ
        ]).setDuration(duration),
        ObjectAnimator.ofFloat(nativeView, 'elevation', [
          elevation
        ]).setDuration(0)
      ])
    );
    ...
    notPressedSet.playTogether(
      java.util.Arrays.asList([
        ObjectAnimator.ofFloat(nativeView, 'translationZ', [z]).setDuration(
          duration
        ),
        ObjectAnimator.ofFloat(nativeView, 'elevation', [
          elevation
  ...
  View.prototype[
    style_properties_1.horizontalAlignmentProperty.getDefault
  ] = function() {
    return org.nativescript.widgets.ViewHelper.getHorizontalAlignment(
      this.nativeViewProtected
    );
  };
  View.prototype[
    style_properties_1.horizontalAlignmentProperty.setNative
  ] = function(value) {
    var nativeView = this.nativeViewProtected;
    var lp =
      nativeView.getLayoutParams() ||
      ...
      switch (value) {
        case 'left':
          lp.gravity =
            ...
            (lp.gravity & android.view.Gravity.VERTICAL_GRAVITY_MASK);
          if (lp.weight < 0) {
            lp.weight = -2;
          }
          break;
  ...
  View.prototype[
    style_properties_1.verticalAlignmentProperty.getDefault
  ] = function() {
    return org.nativescript.widgets.ViewHelper.getVerticalAlignment(
      this.nativeViewProtected
    );
  };
  View.prototype[
    style_properties_1.verticalAlignmentProperty.setNative
  ] = function(value) {
    var nativeView = this.nativeViewProtected;
    var lp =
      nativeView.getLayoutParams() ||
      ...
      switch (value) {
        case 'top':
          lp.gravity =
            ...
            (lp.gravity & android.view.Gravity.HORIZONTAL_GRAVITY_MASK);
          if (lp.height < 0) {
            lp.height = -2;
          }
          break;
  ...
  View.prototype[style_properties_1.rotateProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setRotate(
      this.nativeViewProtected,
      float(value)
    );
  };
  View.prototype[style_properties_1.scaleXProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setScaleX(
      this.nativeViewProtected,
      float(value)
    );
  };
  View.prototype[style_properties_1.scaleYProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setScaleY(
      this.nativeViewProtected,
      float(value)
    );
  };
  View.prototype[style_properties_1.translateXProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setTranslateX(
      this.nativeViewProtected,
      view_common_1.layout.toDevicePixels(value)
    );
  };
  View.prototype[style_properties_1.translateYProperty.setNative] = function(
    value
  ) {
    org.nativescript.widgets.ViewHelper.setTranslateY(
      this.nativeViewProtected,
      view_common_1.layout.toDevicePixels(value)
    );
  };
  ...
  View.prototype[style_properties_1.zIndexProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setZIndex(
      this.nativeViewProtected,
      value
    );
  };
  ...
  View.prototype[style_properties_1.minWidthProperty.setNative] = function(
    value
  ) {
    if (
      this.parent instanceof CustomLayoutView &&
      this.parent.nativeViewProtected
    ) {
  ...
  View.prototype[style_properties_1.minHeightProperty.setNative] = function(
    value
  ) {
    if (
      this.parent instanceof CustomLayoutView &&
  ...
  View.prototype._redrawNativeBackground = function(value) {
    if (value instanceof background_1.Background) {
      ...
      var paddingTop = view_common_1.paddingTopProperty.isSet(style)
        ? this.effectivePaddingTop
        : this._defaultPaddingTop;
      var paddingRight = view_common_1.paddingRightProperty.isSet(style)
        ? this.effectivePaddingRight
        : this._defaultPaddingRight;
      var paddingBottom = view_common_1.paddingBottomProperty.isSet(style)
        ? this.effectivePaddingBottom
        : this._defaultPaddingBottom;
      var paddingLeft = view_common_1.paddingLeftProperty.isSet(style)
        ? this.effectivePaddingLeft
        : this._defaultPaddingLeft;
      if (this._isPaddingRelative) {
        nativeView.setPaddingRelative(
          paddingLeft,
          paddingTop,
          paddingRight,
          paddingBottom
      ...
      if (view_common_1.traceEnabled()) {
        view_common_1.traceWrite(
          this +
            ...
            atIndex +
            ')',
          view_common_1.traceCategories.VisualTreeEvents
        );
      }
  ...
  CustomLayoutView.prototype._removeViewFromNativeVisualTree = function(child) {
    ...
    if (nativeView && childView) {
      ...
      if (view_common_1.traceEnabled()) {
        ...
        view_common_1.traceNotifyEvent(
          child,
          'childInLayoutRemovedFromNativeVisualTree'
        );
      }
    }
  };
  ...
  if (setter) {
    View.prototype[setter] = function(length) {
      ...
      if (length == 'auto') {
        ...
        setPixels(
          this.nativeViewProtected,
          view_common_1.layout.round(
            view_common_1.layout.toDevicePixels(length)
          )
        );
        ...
        setPixels(
          this.nativeViewProtected,
          view_common_1.layout.round(
            view_common_1.layout.toDevicePixels(length.value)
          )
        );
      } else if (length.unit == 'px') {
        setPixels(
          this.nativeViewProtected,
          view_common_1.layout.round(length.value)
        );
      } else if (length.unit == '%') {
