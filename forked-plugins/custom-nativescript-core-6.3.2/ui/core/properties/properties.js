...
function _evaluateCssVariableExpression(view, cssName, value) {
  ...
  while (lastValue !== output) {
    ...
    if (cssVariableValue === null && matched.length) {
      cssVariableValue = _evaluateCssVariableExpression(
        view,
        cssName,
        matched.join(', ')
      ).split(',')[0];
  ...
  function Property(options) {
    ...
    this.set = function(boxedValue) {
      ...
      if (reset) {
        ...
        value = wrapped
          ? observable_1.WrappedValue.unwrap(boxedValue)
          : boxedValue;
      ...
      var changed = equalityComparer
        ? !equalityComparer(oldValue, value)
        : oldValue !== value;
      if (wrapped || changed) {
        if (affectsLayout) {
          this.requestLayout();
    ...
    this.nativeValueChange = function(owner, value) {
      ...
      if (changed) {
        ...
        if (owner.nativeViewProtected && !(defaultValueKey in owner)) {
          owner[defaultValueKey] = owner[getDefault]
            ? owner[getDefault]()
            : defaultValue;
        }
...
var CoercibleProperty = (function(_super) {
  ...
  function CoercibleProperty(options) {
    ...
    _this.coerce = function(target) {
      var originalValue =
        coerceKey in target ? target[coerceKey] : defaultValue;
...
var CssProperty = (function() {
  function CssProperty(options) {
    ...
    function setLocalValue(newValue) {
      ...
      if (!view) {
        trace_1.write(
          newValue + ' not set to view because ".viewRef" is cleared',
      ...
      if (reset) {
        ...
        this[sourceKey] = 3;
        value =
          valueConverter && typeof newValue === 'string'
...
var CssAnimationProperty = (function() {
  function CssAnimationProperty(options) {
    ...
    function descriptor(
      ...
      return {
        ...
        set: function(boxedValue) {
          ...
          if (!view) {
            trace_1.write(
              boxedValue + ' not set to view because ".viewRef" is cleared',
          ...
          var isSet = source !== 0;
          var computedValueChanged =
            oldValue !== value &&
            (!equalityComparer || !equalityComparer(oldValue, value));
    ...
    var defaultPropertyDescriptor = descriptor(
      defaultValueKey,
      0,
      false,
      false,
    ...
    var keyframePropertyDescriptor = descriptor(
      keyframeValue,
      4,
      false,
      false,
  ...
  CssAnimationProperty.prototype._initDefaultNativeValue = function(target) {
    ...
    if (!view) {
      trace_1.write(
        '_initDefaultNativeValue not executed to view because ".viewRef" is cleared',
        trace_1.categories.Animation,
        trace_1.messageType.warn
      );
      return;
    ...
    if (!(defaultValueKey in target)) {
      var getDefault = this.getDefault;
      target[defaultValueKey] = view[getDefault]
        ? view[getDefault]()
        : this.defaultValue;
    }
  };
...
var ShorthandProperty = (function() {
  function ShorthandProperty(options) {
    ...
    function setLocalValue(value) {
      ...
      if (!view) {
        trace_1.write(
          'setLocalValue not executed to view because ".viewRef" is cleared',
          trace_1.categories.Animation,
          trace_1.messageType.warn
        );
        return;
    ...
    function setCssValue(value) {
      ...
      if (!view) {
        trace_1.write(
          'setCssValue not executed to view because ".viewRef" is cleared',
          trace_1.categories.Animation,
          trace_1.messageType.warn
        );
        return;
...
function inheritablePropertyValuesOn(view) {
  var array = new Array();
  for (
    var _i = 0, inheritableProperties_1 = inheritableProperties;
    _i < inheritableProperties_1.length;
    _i++
  ) {
...
function inheritableCssPropertyValuesOn(style) {
  var array = new Array();
  for (
    var _i = 0, inheritableCssProperties_1 = inheritableCssProperties;
    _i < inheritableCssProperties_1.length;
    _i++
  ) {
...
exports.initNativeView = profiling_1.profile(
  '"properties".initNativeView',
      ...
      if (isStyleProperty) {
        ...
        if (property.isSet(view.style)) {
          if (!(defaultValueKey in style)) {
            style[defaultValueKey] = view[getDefault]
              ? view[getDefault]()
              : defaultValue;
          }
...
function clearInheritedProperties(view) {
  for (
    var _i = 0, inheritableProperties_2 = inheritableProperties;
    _i < inheritableProperties_2.length;
    _i++
  ) {
  ...
  var style = view.style;
  for (
    var _a = 0, inheritableCssProperties_2 = inheritableCssProperties;
    _a < inheritableCssProperties_2.length;
    _a++
  ) {
...
function propagateInheritableProperties(view, child) {
  ...
  for (
    var _i = 0, inheritablePropertyValues_1 = inheritablePropertyValues;
    _i < inheritablePropertyValues_1.length;
    _i++
  ) {
...
function propagateInheritableCssProperties(parentStyle, childStyle) {
  var inheritableCssPropertyValues = inheritableCssPropertyValuesOn(
    parentStyle
  );
  for (
    var _i = 0, inheritableCssPropertyValues_1 = inheritableCssPropertyValues;
    _i < inheritableCssPropertyValues_1.length;
    _i++
  ) {
...
function getComputedCssValues(view) {
  ...
  var style = view.style;
  for (
    var _i = 0, cssPropertyNames_1 = cssPropertyNames;
    _i < cssPropertyNames_1.length;
    _i++
  ) {
