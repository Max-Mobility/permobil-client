...
import { Length, paddingBottomProperty, paddingLeftProperty, paddingRightProperty, paddingTopProperty } from "../../styling/style-properties";
import * as ssm from "../../styling/style-scope";
import { Binding, BindingOptions, Observable, PropertyChangeData, traceCategories, traceEnabled, traceWrite, WrappedValue } from "../bindable";
// Types.
import { clearInheritedProperties, CssAnimationProperty, CssProperty, InheritedProperty, initNativeView, propagateInheritableCssProperties, propagateInheritableProperties, Property, Style } from "../properties";
import { ViewBase as ViewBaseDefinition } from "../view-base";
