...
var UITabBarControllerImpl = (function(_super) {
  ...
  __decorate(
    [profiling_1.profile],
    UITabBarControllerImpl.prototype,
    'viewWillAppear',
    null
  );
  __decorate(
...
var UITabBarControllerDelegateImpl = (function(_super) {
  ...
  UITabBarControllerDelegateImpl.prototype.tabBarControllerShouldSelectViewController = function(
    ...
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView.delegate.SHOULD_select(' +
          tabBarController +
          ', ' +
          viewController +
          ');',
        tab_view_common_1.traceCategories.Debug
      );
    }
    var owner = this._owner.get();
    if (owner) {
...
var UINavigationControllerDelegateImpl = (function(_super) {
  ...
  UINavigationControllerDelegateImpl.prototype.navigationControllerWillShowViewControllerAnimated = function(
    ...
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView.moreNavigationController.WILL_show(' +
          navigationController +
          ', ' +
          viewController +
          ', ' +
  ...
  UINavigationControllerDelegateImpl.prototype.navigationControllerDidShowViewControllerAnimated = function(
    ...
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView.moreNavigationController.DID_show(' +
          navigationController +
          ', ' +
          viewController +
          ', ' +
...
var TabViewItem = (function(_super) {
  ...
  TabViewItem.prototype._update = function() {
    ...
    if (parent && controller) {
      ...
      var title = text_base_1.getTransformedText(
        this.title,
  ...
  TabViewItem.prototype._updateTitleAndIconPositions = function() {
    ...
    updateTitleAndIconPositions(
      this,
      this.__controller.tabBarItem,
      this.__controller
    );
  };
  TabViewItem.prototype[text_base_1.textTransformProperty.setNative] = function(
    value
  ) {
    this._update();
  };
...
var TabView = (function(_super) {
  ...
  TabView.prototype.onLoaded = function() {
    ...
    var selectedView =
      this.items && this.items[selectedIndex] && this.items[selectedIndex].view;
  ...
  TabView.prototype.onMeasure = function(widthMeasureSpec, heightMeasureSpec) {
    ...
    var widthMode = tab_view_common_1.layout.getMeasureSpecMode(
      widthMeasureSpec
    );
    var height = tab_view_common_1.layout.getMeasureSpecSize(heightMeasureSpec);
    var heightMode = tab_view_common_1.layout.getMeasureSpecMode(
      heightMeasureSpec
    );
    var widthAndState = tab_view_common_1.View.resolveSizeAndState(
      width,
      width,
      widthMode,
      0
    );
    var heightAndState = tab_view_common_1.View.resolveSizeAndState(
      height,
      height,
      heightMode,
      0
  ...
  TabView.prototype._onViewControllerShown = function(viewController) {
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView._onViewControllerShown(' + viewController + ');',
        tab_view_common_1.traceCategories.Debug
      );
    }
    if (
      ...
      if (tab_view_common_1.traceEnabled()) {
        tab_view_common_1.traceWrite(
          'TabView._onViewControllerShown: viewController is not one of our viewControllers',
          tab_view_common_1.traceCategories.Debug
        );
      }
    }
  };
  TabView.prototype._handleTwoNavigationBars = function(
    backToMoreWillBeVisible
  ) {
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView._handleTwoNavigationBars(backToMoreWillBeVisible: ' +
          backToMoreWillBeVisible +
          ')',
        tab_view_common_1.traceCategories.Debug
      );
  ...
  TabView.prototype._getIcon = function(iconSource) {
    ...
    if (!image) {
      ...
      if (is && is.ios) {
        var originalRenderedImage = is.ios.imageWithRenderingMode(
          this._getIconRenderingMode()
        );
  ...
  TabView.prototype[
    tab_view_common_1.selectedIndexProperty.setNative
  ] = function(value) {
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView._onSelectedIndexPropertyChangedSetNativeValue(' + value + ')',
        tab_view_common_1.traceCategories.Debug
      );
    }
    if (value > -1) {
  ...
  TabView.prototype[tab_view_common_1.itemsProperty.setNative] = function(
    value
  ) {
  ...
  TabView.prototype[
    tab_view_common_1.tabTextFontSizeProperty.getDefault
  ] = function() {
    return null;
  };
  TabView.prototype[
    tab_view_common_1.tabTextFontSizeProperty.setNative
  ] = function(value) {
    this._updateIOSTabBarColorsAndFonts();
  };
  TabView.prototype[
    tab_view_common_1.tabTextColorProperty.getDefault
  ] = function() {
    return null;
  };
  TabView.prototype[
    tab_view_common_1.tabTextColorProperty.setNative
  ] = function(value) {
    this._updateIOSTabBarColorsAndFonts();
  };
  TabView.prototype[
    tab_view_common_1.tabBackgroundColorProperty.getDefault
  ] = function() {
    return this._ios.tabBar.barTintColor;
  };
  TabView.prototype[
    tab_view_common_1.tabBackgroundColorProperty.setNative
  ] = function(value) {
    this._ios.tabBar.barTintColor =
      value instanceof tab_view_common_1.Color ? value.ios : value;
  };
  TabView.prototype[
    tab_view_common_1.selectedTabTextColorProperty.getDefault
  ] = function() {
    return this._ios.tabBar.tintColor;
  };
  TabView.prototype[
    tab_view_common_1.selectedTabTextColorProperty.setNative
  ] = function(value) {
    this._ios.tabBar.tintColor =
      value instanceof tab_view_common_1.Color ? value.ios : value;
    this._updateIOSTabBarColorsAndFonts();
  };
  TabView.prototype[
    tab_view_common_1.fontInternalProperty.getDefault
  ] = function() {
    return null;
  };
  TabView.prototype[
    tab_view_common_1.fontInternalProperty.setNative
  ] = function(value) {
    this._updateIOSTabBarColorsAndFonts();
  };
  TabView.prototype[
    tab_view_common_1.iosIconRenderingModeProperty.getDefault
  ] = function() {
    return 'automatic';
  };
  TabView.prototype[
    tab_view_common_1.iosIconRenderingModeProperty.setNative
  ] = function(value) {
    this._iconsCache = {};
    var items = this.items;
...
function getTitleAttributesForStates(tabView) {
  ...
  var font = tabView.style.fontInternal.getUIFont(
    UIFont.systemFontOfSize(tabItemFontSize)
  );
  var tabItemTextColor = tabView.style.tabTextColor;
  var textColor =
    tabItemTextColor instanceof tab_view_common_1.Color
      ? tabItemTextColor.ios
      : null;
  ...
  var selectedTextColor =
    tabSelectedItemTextColor instanceof tab_view_common_1.Color
