import { AddArrayFromBuilder, AddChildFromBuilder, booleanConverter, CoercibleProperty, Color, CssProperty, CSSType, EventData, isIOS, Property, Style, traceCategories, traceMessageType, traceWrite, View, ViewBase } from "../core/view";
import { SelectedIndexChangedEventData, TabView as TabViewDefinition, TabViewItem as TabViewItemDefinition } from "../tab-view";
