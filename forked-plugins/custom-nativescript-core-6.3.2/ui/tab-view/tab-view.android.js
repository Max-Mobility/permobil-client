    ...
    TabFragmentImplementation.prototype.onDestroyView = function() {
      ...
      if (hasRemovingParent && this.owner.selectedIndex === this.index) {
        ...
        this.owner._originalBackground =
          this.owner.backgroundColor || new tab_view_common_1.Color('White');
...
function createTabItemSpec(item) {
  ...
  if (item.iconSource) {
    if (item.iconSource.indexOf(utils_1.RESOURCE_PREFIX) === 0) {
      result.iconId = utils_1.ad.resources.getDrawableId(
        item.iconSource.substr(utils_1.RESOURCE_PREFIX.length)
      );
      if (result.iconId === 0) {
        tab_view_common_1.traceMissingIcon(item.iconSource);
      }
    } else {
      var is = image_source_1.ImageSource.fromFileOrResourceSync(
        item.iconSource
      );
      if (is) {
...
var TabViewItem = (function(_super) {
    ...
    if (!tabFragment) {
      if (tab_view_common_1.traceEnabled()) {
        tab_view_common_1.traceWrite(
          'Could not get child fragment manager for tab item with index ' +
            this.index,
          tab_view_common_1.traceCategory
        );
      }
  ...
  TabViewItem.prototype[
    tab_view_common_1.fontSizeProperty.getDefault
  ] = function() {
    return { nativeSize: this.nativeViewProtected.getTextSize() };
  };
  TabViewItem.prototype[
    tab_view_common_1.fontSizeProperty.setNative
  ] = function(value) {
  ...
  TabViewItem.prototype[
    text_base_1.textTransformProperty.getDefault
  ] = function() {
    return 'default';
  };
...
var TabView = (function(_super) {
  ...
  TabView.prototype[
    tab_view_common_1.androidOffscreenTabLimitProperty.getDefault
  ] = function() {
    return this._viewPager.getOffscreenPageLimit();
  };
  TabView.prototype[
    tab_view_common_1.androidOffscreenTabLimitProperty.setNative
  ] = function(value) {
  ...
  TabView.prototype[
    ...
    if (tab_view_common_1.traceEnabled()) {
      tab_view_common_1.traceWrite(
        'TabView this._viewPager.setCurrentItem(' +
          value +
          ', ' +
          smoothScroll +
          ');',
  ...
  TabView.prototype[
    ...
    var color =
      value instanceof tab_view_common_1.Color ? value.android : value;
  ...
  TabView.prototype[
    tab_view_common_1.androidSelectedTabHighlightColorProperty.getDefault
  ] = function() {
    return getDefaultAccentColor(this._context);
  };
  TabView.prototype[
    tab_view_common_1.androidSelectedTabHighlightColorProperty.setNative
  ] = function(value) {
