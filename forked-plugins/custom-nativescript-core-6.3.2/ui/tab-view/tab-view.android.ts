...
import { TabViewItem as TabViewItemDefinition } from "../tab-view";
import { getTransformedText, TextTransform, textTransformProperty } from "../text-base";
import { androidOffscreenTabLimitProperty, androidSelectedTabHighlightColorProperty, Color, fontInternalProperty, fontSizeProperty, itemsProperty, layout, selectedIndexProperty, selectedTabTextColorProperty, tabBackgroundColorProperty, tabTextColorProperty, tabTextFontSizeProperty, TabViewBase, TabViewItemBase, traceCategory, traceEnabled, traceMissingIcon, traceWrite } from "./tab-view-common";
