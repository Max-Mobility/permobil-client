...
import { Color, fontInternalProperty, iosIconRenderingModeProperty, itemsProperty, layout, selectedIndexProperty, selectedTabTextColorProperty, tabBackgroundColorProperty, tabTextColorProperty, tabTextFontSizeProperty, TabViewBase, TabViewItemBase, traceCategories, traceEnabled, traceMissingIcon, traceWrite, View } from "./tab-view-common";
