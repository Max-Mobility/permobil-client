...
exports.minWidthProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (view) {
      ...
      trace_1.write(
        newValue + ' not set to view\'s property because ".viewRef" is cleared',
        trace_1.categories.Style,
        trace_1.messageType.warn
      );
    }
  },
...
var marginProperty = new properties_1.ShorthandProperty({
  ...
  getter: function() {
    ...
    return (
      PercentLength.convertToString(this.marginTop) +
      ' ' +
      PercentLength.convertToString(this.marginRight) +
      ' ' +
      PercentLength.convertToString(this.marginBottom) +
      ' ' +
...
var paddingProperty = new properties_1.ShorthandProperty({
  ...
  getter: function() {
    if (
      Length.equals(this.paddingTop, this.paddingRight) &&
    ...
    return (
      Length.convertToString(this.paddingTop) +
      ' ' +
      Length.convertToString(this.paddingRight) +
      ' ' +
      Length.convertToString(this.paddingBottom) +
      ' ' +
      Length.convertToString(this.paddingLeft)
    );
  },
...
(function(HorizontalAlignment) {
  ...
  HorizontalAlignment.isValid = properties_1.makeValidator(
    HorizontalAlignment.LEFT,
    HorizontalAlignment.CENTER,
    HorizontalAlignment.RIGHT,
    HorizontalAlignment.STRETCH
  );
  HorizontalAlignment.parse = properties_1.makeParser(
    HorizontalAlignment.isValid
  );
})(
  (HorizontalAlignment =
...
(function(VerticalAlignment) {
  ...
  VerticalAlignment.isValid = properties_1.makeValidator(
  ...
  VerticalAlignment.parse = function(value) {
    return value.toLowerCase() === 'center'
      ? VerticalAlignment.MIDDLE
      : parseStrict(value);
  };
...
function parseDIPs(value) {
  if (value.indexOf('px') !== -1) {
    return utils_1.layout.toDeviceIndependentPixels(
      parseFloat(value.replace('px', '').trim())
    );
  } else {
...
var STYLE_TRANSFORMATION_MAP = Object.freeze({
  scale: function(value) {
    return { property: 'scale', value: value };
  },
  ...
  translate: function(value) {
    return { property: 'translate', value: value };
  },
  ...
  rotate: function(value) {
    return { property: 'rotate', value: value };
  }
});
...
function parseTransformString(text) {
  ...
  while ((match = TRANSFORM_SPLITTER.exec(text)) !== null) {
    ...
    if (TRANSFORMATIONS.indexOf(property) !== -1) {
      matches.push(
        normalizeTransformation({ property: property, value: value })
      );
    }
  }
  return matches;
...
function convertTransformValue(property, stringValue) {
  ...
  if (property === 'rotate') {
    return stringValue.slice(-3) === 'rad'
      ? number_utils_1.radiansToDegrees(x)
      : x;
  }
  return { x: x, y: y };
}
...
exports.backgroundImageProperty = new properties_1.CssProperty({
  ...
  equalityComparer: function(value1, value2) {
    if (
      value1 instanceof linear_gradient_1.LinearGradient &&
      value2 instanceof linear_gradient_1.LinearGradient
    ) {
      ...
      if (parsed) {
        ...
        value =
          typeof background.image === 'object'
            ? linear_gradient_1.LinearGradient.parse(background.image)
            : value;
      }
    }
    return value;
...
(function(BackgroundRepeat) {
  ...
  BackgroundRepeat.isValid = properties_1.makeValidator(
  ...
  (BackgroundRepeat =
    exports.BackgroundRepeat || (exports.BackgroundRepeat = {}))
);
...
function convertToBackgrounds(value) {
  if (typeof value === 'string') {
    ...
    var backgroundColor = backgrounds.color
      ? new color_1.Color(backgrounds.color)
      : properties_1.unsetValue;
    var backgroundImage = void 0;
    if (typeof backgrounds.image === 'object' && backgrounds.image) {
      backgroundImage = linear_gradient_1.LinearGradient.parse(
        backgrounds.image
      );
    } else {
    ...
    var backgroundPosition = backgrounds.position
      ? backgrounds.position.text
      : properties_1.unsetValue;
    return [
...
function parseBorderColor(value) {
  ...
  if (value.indexOf('rgb') === 0) {
    result.top = result.right = result.bottom = result.left = new color_1.Color(
      value
    );
    return result;
  }
...
var borderColorProperty = new properties_1.ShorthandProperty({
  ...
  getter: function() {
    if (
      color_1.Color.equals(this.borderTopColor, this.borderRightColor) &&
...
var borderWidthProperty = new properties_1.ShorthandProperty({
  ...
  getter: function() {
    if (
      Length.equals(this.borderTopWidth, this.borderRightWidth) &&
      ...
      return (
        Length.convertToString(this.borderTopWidth) +
        ' ' +
        Length.convertToString(this.borderRightWidth) +
        ' ' +
        Length.convertToString(this.borderBottomWidth) +
        ' ' +
        Length.convertToString(this.borderLeftWidth)
      );
    }
  },
  converter: function(value) {
...
exports.borderTopWidthProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-top-width should be Non-Negative Finite number. Value: ' + value
      );
    }
    var view = target.viewRef.get();
    if (view) {
...
exports.borderRightWidthProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-right-width should be Non-Negative Finite number. Value: ' +
          value
      );
    }
    var view = target.viewRef.get();
...
exports.borderBottomWidthProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-bottom-width should be Non-Negative Finite number. Value: ' +
          value
      );
    }
    var view = target.viewRef.get();
...
exports.borderLeftWidthProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-left-width should be Non-Negative Finite number. Value: ' +
          value
      );
    }
    var view = target.viewRef.get();
...
var borderRadiusProperty = new properties_1.ShorthandProperty({
  ...
  getter: function() {
    ...
    return (
      Length.convertToString(this.borderTopLeftRadius) +
      ' ' +
      Length.convertToString(this.borderTopRightRadius) +
      ' ' +
      Length.convertToString(this.borderBottomRightRadius) +
      ' ' +
...
exports.borderTopLeftRadiusProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-top-left-radius should be Non-Negative Finite number. Value: ' +
          value
      );
    }
...
exports.borderTopRightRadiusProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-top-right-radius should be Non-Negative Finite number. Value: ' +
          value
      );
    }
...
exports.borderBottomRightRadiusProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-bottom-right-radius should be Non-Negative Finite number. Value: ' +
          value
      );
    }
    var background = target.backgroundInternal.withBorderBottomRightRadius(
      value
    );
    target.backgroundInternal = background;
  },
...
exports.borderBottomLeftRadiusProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (!isNonNegativeFiniteNumber(value)) {
      throw new Error(
        'border-bottom-left-radius should be Non-Negative Finite number. Value: ' +
          value
      );
    }
    var background = target.backgroundInternal.withBorderBottomLeftRadius(
      value
    );
    target.backgroundInternal = background;
  },
...
exports.fontFamilyProperty = new properties_1.InheritedCssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    ...
    if (currentFont.fontFamily !== newValue) {
      ...
      target.fontInternal = font_1.Font.equals(font_1.Font.default, newFont)
        ? properties_1.unsetValue
        : newFont;
    }
  }
...
(function(Visibility) {
  ...
  Visibility.isValid = properties_1.makeValidator(
    Visibility.VISIBLE,
    Visibility.HIDDEN,
    Visibility.COLLAPSE
  );
  Visibility.parse = function(value) {
    return value.toLowerCase() === 'collapsed'
      ? Visibility.COLLAPSE
      : parseStrict(value);
  };
