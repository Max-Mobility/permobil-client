...
var Font = (function() {
  ...
  Font.equals = function(value1, value2) {
    ...
    return (
      value1.fontFamily === value2.fontFamily &&
...
(function(FontStyle) {
  ...
  FontStyle.isValid = properties_1.makeValidator(
    FontStyle.NORMAL,
    FontStyle.ITALIC
  );
...
(function(FontWeight) {
  ...
  FontWeight.isValid = properties_1.makeValidator(
    FontWeight.THIN,
...
(function(genericFontFamilies) {
  ...
  (genericFontFamilies =
    exports.genericFontFamilies || (exports.genericFontFamilies = {}))
);
var styles = new Set();
