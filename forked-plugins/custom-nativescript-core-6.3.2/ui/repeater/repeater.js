...
var Repeater = (function(_super) {
  ...
  Repeater.prototype.refresh = function() {
    ...
    for (var i = 0; i < length; i++) {
      var viewToAdd = this.itemTemplate
        ? builder_1.Builder.parse(this.itemTemplate, this)
  ...
  Repeater.prototype.onLayout = function(left, top, right, bottom) {
    ...
    layout_base_1.View.layoutChild(
      this,
      this.itemsLayout,
      childLeft,
      childTop,
  ...
  Repeater.prototype.onMeasure = function(widthMeasureSpec, heightMeasureSpec) {
    var result = layout_base_1.View.measureChild(
      this,
      this.itemsLayout,
      widthMeasureSpec,
      heightMeasureSpec
    ...
    var widthAndState = layout_base_1.View.resolveSizeAndState(
      result.measuredWidth,
      width,
      widthMode,
      0
    );
    var heightAndState = layout_base_1.View.resolveSizeAndState(
  ...
  valueChanged: function(target, oldValue, newValue) {
    if (oldValue instanceof observable_array_1.ObservableArray) {
      weak_event_listener_1.removeWeakEventListener(
        oldValue,
        observable_array_1.ObservableArray.changeEvent,
