...
(function(knownMultiTemplates) {
  ...
  (knownMultiTemplates =
    exports.knownMultiTemplates || (exports.knownMultiTemplates = {}))
);
...
var ListViewBase = (function(_super) {
  ...
  ListViewBase.prototype._onRowHeightPropertyChanged = function(
    oldValue,
    newValue
  ) {
    this.refresh();
...
exports.rowHeightProperty = new view_1.CoercibleProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    target._effectiveRowHeight = view_1.Length.toDevicePixels(
      newValue,
