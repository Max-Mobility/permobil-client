...
function initializeTimeChangedListener() {
  ...
  var TimeChangedListenerImpl = (function(_super) {
    ...
    TimeChangedListenerImpl.prototype.onTimeChanged = function(
      picker,
      hour,
      minute
    ) {
      ...
      var validTime = time_picker_common_1.getValidTime(
        timePicker,
        hour,
        minute
      );
      time_picker_common_1.timeProperty.nativeValueChange(
        timePicker,
        new Date(0, 0, 0, validTime.hour, validTime.minute)
      );
    };
...
var TimePicker = (function(_super) {
  ...
  TimePicker.prototype.initNativeView = function() {
    ...
    var hour = time_picker_common_1.hourProperty.isSet(this)
      ? this.hour
      : calendar.get(java.util.Calendar.HOUR_OF_DAY);
    var minute = time_picker_common_1.minuteProperty.isSet(this)
      ? this.minute
