...
function initializeDateChangedListener() {
  ...
  var DateChangedListenerImpl = (function(_super) {
    ...
    DateChangedListenerImpl.prototype.onDateChanged = function(
      picker,
      year,
      month,
      day
...
var DatePicker = (function(_super) {
  ...
  DatePicker.prototype.updateNativeDate = function() {
    ...
    var month =
      typeof this.month === 'number' ? this.month - 1 : nativeView.getMonth();
    var day =
      typeof this.day === 'number' ? this.day : nativeView.getDayOfMonth();
