...
var ScrollView = (function(_super) {
  ...
  Object.defineProperty(ScrollView.prototype, 'horizontalOffset', {
    get: function() {
      ...
      return (
        nativeView.getScrollX() /
        scroll_view_common_1.layout.getDisplayDensity()
      );
    },
    enumerable: true,
    configurable: true
  ...
  Object.defineProperty(ScrollView.prototype, 'scrollableWidth', {
    get: function() {
      ...
      return (
        nativeView.getScrollableLength() /
        scroll_view_common_1.layout.getDisplayDensity()
      );
    },
    enumerable: true,
  ...
  ScrollView.prototype[
    scroll_view_common_1.isUserInteractionEnabledProperty.setNative
  ] = function(value) {
  ...
  ScrollView.prototype.createNativeView = function() {
    return this.orientation === 'horizontal'
      ? new org.nativescript.widgets.HorizontalScrollView(this._context)
      : new org.nativescript.widgets.VerticalScrollView(this._context);
  };
  ...
  ScrollView.prototype.attachNative = function() {
    ...
    this.nativeViewProtected
      .getViewTreeObserver()
      .addOnScrollChangedListener(this.handler);
  };
  ScrollView.prototype._onScrollChanged = function() {
    ...
    if (nativeView) {
      ...
      if (
        newScrollX !== this._lastScrollX ||
        newScrollY !== this._lastScrollY
      ) {
        this.notify({
          object: this,
  ...
  ScrollView.prototype.dettachNative = function() {
    this.nativeViewProtected
      .getViewTreeObserver()
      .removeOnScrollChangedListener(this.handler);
    this.handler = null;
  };
  return ScrollView;
