...
(function(FlexDirection) {
  ...
  FlexDirection.isValid = layout_base_1.makeValidator(
    FlexDirection.ROW,
...
(function(FlexWrap) {
  ...
  FlexWrap.isValid = layout_base_1.makeValidator(
    FlexWrap.NOWRAP,
    FlexWrap.WRAP,
...
(function(JustifyContent) {
  ...
  JustifyContent.isValid = layout_base_1.makeValidator(
...
(function(FlexBasisPercent) {
  ...
  (FlexBasisPercent =
    exports.FlexBasisPercent || (exports.FlexBasisPercent = {}))
);
var AlignItems;
(function(AlignItems) {
  ...
  AlignItems.isValid = layout_base_1.makeValidator(
...
(function(AlignContent) {
  ...
  AlignContent.isValid = layout_base_1.makeValidator(
...
(function(AlignSelf) {
  ...
  AlignSelf.isValid = layout_base_1.makeValidator(
    AlignSelf.AUTO,
    ...
    if (value === layout_base_1.unsetValue) {
      ...
      if (trimmed) {
        ...
        if (values.length >= 1 && FlexDirection.isValid(values[0])) {
          properties.push([
            exports.flexDirectionProperty,
            FlexDirection.parse(values[0])
          ]);
        }
        if (value.length >= 2 && FlexWrap.isValid(values[1])) {
          properties.push([
            exports.flexWrapProperty,
            FlexWrap.parse(values[1])
          ]);
        }
      }
    }
      ...
      if (trimmed) {
          ...
          switch (values[0]) {
            ...
            default:
              if (FlexGrow.isValid(values[0])) {
                properties.push([
                  exports.flexGrowProperty,
                  FlexGrow.parse(values[0])
                ]);
                properties.push([exports.flexShrinkProperty, 1]);
              }
          }
        ...
        if (values.length >= 2) {
          if (FlexGrow.isValid(values[0]) && FlexShrink.isValid(values[1])) {
            ...
            properties.push([
              exports.flexShrinkProperty,
              FlexShrink.parse(values[1])
            ]);
          }
        }
      }
