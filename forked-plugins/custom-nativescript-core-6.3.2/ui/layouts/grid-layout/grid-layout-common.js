...
var ItemSpec = (function(_super) {
  ...
  function ItemSpec() {
    ...
    if (arguments.length === 0) {
      ...
      if (typeof value === 'number' && typeof type === 'string') {
        ...
        throw new Error(
          'First argument should be number, second argument should be string.'
        );
      }
    } else {
  ...
  ItemSpec.equals = function(value1, value2) {
    return (
      value1.gridUnitType === value2.gridUnitType &&
      value1.value === value2.value &&
      value1.owner === value2.owner &&
...
var GridLayoutBase = (function(_super) {
  ...
  GridLayoutBase.prototype.addChildAtCell = function(
    view,
    row,
    column,
    rowSpan,
  ...
  GridLayoutBase.prototype.onRowChanged = function(
    element,
    oldValue,
    newValue
  ) {
  ...
  GridLayoutBase.prototype.onRowSpanChanged = function(
    element,
    oldValue,
    newValue
  ) {
  ...
  GridLayoutBase.prototype.onColumnChanged = function(
    element,
    oldValue,
    newValue
  ) {
  ...
  GridLayoutBase.prototype.onColumnSpanChanged = function(
    element,
    oldValue,
    newValue
  ) {
...
(function(GridUnitType) {
  ...
  GridUnitType.isValid = layout_base_1.makeValidator(
    GridUnitType.PIXEL,
    GridUnitType.STAR,
    GridUnitType.AUTO
  );
