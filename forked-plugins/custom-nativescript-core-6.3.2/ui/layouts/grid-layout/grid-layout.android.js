...
grid_layout_common_1.View.prototype[
  grid_layout_common_1.rowProperty.setNative
] = makeNativeSetter(function(lp, value) {
  return (lp.row = value);
});
grid_layout_common_1.View.prototype[
  grid_layout_common_1.columnProperty.setNative
] = makeNativeSetter(function(lp, value) {
  return (lp.column = value);
});
grid_layout_common_1.View.prototype[
  grid_layout_common_1.rowSpanProperty.setNative
] = makeNativeSetter(function(lp, value) {
  return (lp.rowSpan = value);
});
grid_layout_common_1.View.prototype[
  grid_layout_common_1.columnSpanProperty.setNative
] = makeNativeSetter(function(lp, value) {
...
function createNativeSpec(itemSpec) {
  switch (itemSpec.gridUnitType) {
    case grid_layout_common_1.GridUnitType.AUTO:
      return new org.nativescript.widgets.ItemSpec(
        itemSpec.value,
    ...
    case grid_layout_common_1.GridUnitType.PIXEL:
      return new org.nativescript.widgets.ItemSpec(
        itemSpec.value * grid_layout_common_1.layout.getDisplayDensity(),
        org.nativescript.widgets.GridUnitType.pixel
      );
    default:
...
var ItemSpec = (function(_super) {
  ...
  Object.defineProperty(ItemSpec.prototype, 'actualLength', {
    get: function() {
      if (this.nativeSpec) {
        return Math.round(
          this.nativeSpec.getActualLength() /
            grid_layout_common_1.layout.getDisplayDensity()
        );
      }
      return 0;
    },
