...
exports.itemWidthProperty = new layout_base_1.Property({
  ...
  valueChanged: function(target, oldValue, newValue) {
    return (target.effectiveItemWidth = layout_base_1.Length.toDevicePixels(
      newValue,
      -1
    ));
  }
...
exports.itemHeightProperty = new layout_base_1.Property({
  ...
  valueChanged: function(target, oldValue, newValue) {
    return (target.effectiveItemHeight = layout_base_1.Length.toDevicePixels(
      newValue,
      -1
    ));
  }
...
var converter = layout_base_1.makeParser(
  layout_base_1.makeValidator('horizontal', 'vertical')
);
