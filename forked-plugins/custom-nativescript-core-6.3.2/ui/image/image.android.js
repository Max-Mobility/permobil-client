...
var Image = (function(_super) {
  ...
  Image.prototype._createImageSourceFromSrc = function(value) {
    ...
    var decodeWidth = Math.min(
      image_common_1.Length.toDevicePixels(this.decodeWidth, 0),
      screen.widthPixels
    );
    var decodeHeight = Math.min(
      image_common_1.Length.toDevicePixels(this.decodeHeight, 0),
      screen.heightPixels
    );
    ...
    if (typeof value === 'string' || value instanceof String) {
      ...
      this.isLoading = true;
      if (
        image_common_1.isFontIconURI(value) ||
        image_common_1.isDataURI(value)
      ) {
