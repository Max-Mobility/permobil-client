...
(function(knownCollections) {
  ...
  (knownCollections =
    exports.knownCollections || (exports.knownCollections = {}))
);
var ActionBarBase = (function(_super) {
    ...
    set: function(value) {
      if (this._titleView !== value) {
        if (this._titleView) {
          ...
          this._titleView.style[view_1.horizontalAlignmentProperty.cssName] =
            view_1.unsetValue;
          this._titleView.style[view_1.verticalAlignmentProperty.cssName] =
            view_1.unsetValue;
        }
  ...
  Object.defineProperty(ActionBarBase.prototype, 'androidContentInset', {
    get: function() {
  ...
  Object.defineProperty(ActionBarBase.prototype, 'androidContentInsetLeft', {
    get: function() {
  ...
  Object.defineProperty(ActionBarBase.prototype, 'androidContentInsetRight', {
    get: function() {
  ...
  Object.defineProperty(ActionItemBase.prototype, 'actionView', {
    ...
    set: function(value) {
      if (this._actionView !== value) {
        if (this._actionView) {
          this._actionView.style[view_1.horizontalAlignmentProperty.cssName] =
            view_1.unsetValue;
          this._actionView.style[view_1.verticalAlignmentProperty.cssName] =
            view_1.unsetValue;
...
function traceMissingIcon(icon) {
  view_1.traceWrite(
    'Could not load action bar icon: ' + icon,
    view_1.traceCategories.Error,
...
function convertToContentInset(value) {
  if (typeof value === 'string' && value !== 'auto') {
    var insets = value.split(/[ ,]+/);
    return [
      [exports.androidContentInsetLeftProperty, view_2.Length.parse(insets[0])],
      [
        exports.androidContentInsetRightProperty,
        view_2.Length.parse(insets[1] || insets[0])
      ]
    ];
  } else {
    return [
      [exports.androidContentInsetLeftProperty, value],
      [exports.androidContentInsetRightProperty, value]
    ];
  }
}
...
var androidContentInsetProperty = new properties_1.ShorthandProperty({
  name: 'androidContentInset',
  cssName: 'android-content-inset',
  getter: function() {
    if (
      view_2.Length.equals(
        this.androidContentInsetLeft,
        this.androidContentInsetRight
      )
    ) {
      return this.androidContentInsetLeft;
    }
    return (
      view_2.Length.convertToString(this.androidContentInsetLeft) +
      ' ' +
      view_2.Length.convertToString(this.androidContentInsetRight)
    );
  },
  converter: convertToContentInset
});
androidContentInsetProperty.register(properties_1.Style);
exports.androidContentInsetLeftProperty = new properties_1.CssProperty({
  name: 'androidContentInsetLeft',
  cssName: 'android-content-inset-left',
  defaultValue: 'auto',
  equalityComparer: view_2.Length.equals,
  valueChanged: function(target, oldValue, newValue) {
    var view = target.viewRef.get();
    if (view) {
      view.effectiveContentInsetLeft = view_2.Length.toDevicePixels(newValue);
    } else {
      view_1.traceWrite(
        newValue + ' not set to view\'s property because ".viewRef" is cleared',
        view_1.traceCategories.Style,
        view_1.traceMessageType.warn
      );
    }
  },
  valueConverter: view_2.Length.parse
});
exports.androidContentInsetLeftProperty.register(properties_1.Style);
exports.androidContentInsetRightProperty = new properties_1.CssProperty({
  ...
  valueChanged: function(target, oldValue, newValue) {
    var view = target.viewRef.get();
    if (view) {
      view.effectiveContentInsetRight = view_2.Length.toDevicePixels(newValue);
    } else {
      view_1.traceWrite(
        newValue + ' not set to view\'s property because ".viewRef" is cleared',
        view_1.traceCategories.Style,
...
exports.androidContentInsetRightProperty.register(properties_1.Style);
