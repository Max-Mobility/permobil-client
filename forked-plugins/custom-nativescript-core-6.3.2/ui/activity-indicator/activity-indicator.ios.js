...
var ActivityIndicator = (function(_super) {
  ...
  ActivityIndicator.prototype.createNativeView = function() {
    ...
    var view = UIActivityIndicatorView.alloc().initWithActivityIndicatorStyle(
      viewStyle
    );
  ...
  ActivityIndicator.prototype[
    ...
    this.nativeViewProtected.color =
      value instanceof activity_indicator_common_1.Color ? value.ios : value;
  };
