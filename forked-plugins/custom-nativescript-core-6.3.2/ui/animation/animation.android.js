...
var propertyKeys = {};
propertyKeys[animation_common_1.Properties.backgroundColor] = Symbol(
  keyPrefix + animation_common_1.Properties.backgroundColor
);
propertyKeys[animation_common_1.Properties.opacity] = Symbol(
  keyPrefix + animation_common_1.Properties.opacity
);
propertyKeys[animation_common_1.Properties.rotate] = Symbol(
  keyPrefix + animation_common_1.Properties.rotate
);
propertyKeys[animation_common_1.Properties.scale] = Symbol(
  keyPrefix + animation_common_1.Properties.scale
);
propertyKeys[animation_common_1.Properties.translate] = Symbol(
  keyPrefix + animation_common_1.Properties.translate
);
propertyKeys[animation_common_1.Properties.height] = Symbol(
  keyPrefix + animation_common_1.Properties.height
);
propertyKeys[animation_common_1.Properties.width] = Symbol(
  keyPrefix + animation_common_1.Properties.width
);
function _resolveAnimationCurve(curve) {
  switch (curve) {
    case 'easeIn':
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animation curve resolved to android.view.animation.AccelerateInterpolator(1).',
          animation_common_1.traceCategories.Animation
        );
      }
      return easeIn();
    case 'easeOut':
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animation curve resolved to android.view.animation.DecelerateInterpolator(1).',
          animation_common_1.traceCategories.Animation
        );
      }
      return easeOut();
    case 'easeInOut':
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animation curve resolved to android.view.animation.AccelerateDecelerateInterpolator().',
          animation_common_1.traceCategories.Animation
        );
      }
      return easeInOut();
    case 'linear':
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animation curve resolved to android.view.animation.LinearInterpolator().',
          animation_common_1.traceCategories.Animation
        );
      }
      return linear();
    case 'spring':
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animation curve resolved to android.view.animation.BounceInterpolator().',
          animation_common_1.traceCategories.Animation
        );
      }
      return bounce();
    case 'ease':
      return androidx.core.view.animation.PathInterpolatorCompat.create(
        0.25,
        0.1,
        0.25,
        1.0
    ...
    default:
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animation curve resolved to original: ' + curve,
          animation_common_1.traceCategories.Animation
        );
      }
...
var Animation = (function(_super) {
  ...
  function Animation(animationDefinitions, playSequentially) {
    var _this =
      _super.call(this, animationDefinitions, playSequentially) || this;
    _this._resetOnFinish = true;
    _this._valueSource = 'animation';
    if (
      animationDefinitions.length > 0 &&
      animationDefinitions[0].valueSource !== undefined
    ) {
    ...
    _this._animatorListener = new android.animation.Animator.AnimatorListener({
      onAnimationStart: function(animator) {
        if (animation_common_1.traceEnabled()) {
          animation_common_1.traceWrite(
            'MainAnimatorListener.onAndroidAnimationStart(' + animator + ')',
            animation_common_1.traceCategories.Animation
          );
        }
      },
      onAnimationRepeat: function(animator) {
        if (animation_common_1.traceEnabled()) {
          animation_common_1.traceWrite(
            'MainAnimatorListener.onAnimationRepeat(' + animator + ')',
            animation_common_1.traceCategories.Animation
          );
        }
      },
      onAnimationEnd: function(animator) {
        if (animation_common_1.traceEnabled()) {
          animation_common_1.traceWrite(
            'MainAnimatorListener.onAnimationEnd(' + animator + ')',
            animation_common_1.traceCategories.Animation
          );
        }
      ...
      onAnimationCancel: function(animator) {
        if (animation_common_1.traceEnabled()) {
          animation_common_1.traceWrite(
            'MainAnimatorListener.onAnimationCancel(' + animator + ')',
            animation_common_1.traceCategories.Animation
          );
        }
        var thisRef = that.get();
  ...
  Animation.prototype.play = function(resetOnFinish) {
    ...
    for (
      var i = 0, length_1 = this._propertyAnimations.length;
      i < length_1;
      i++
    ) {
      this._createAnimators(this._propertyAnimations[i]);
    }
    this._nativeAnimatorsArray = Array.create(
      android.animation.Animator,
      this._animators.length
    );
  ...
  Animation.prototype.cancel = function() {
    if (!this.isPlaying) {
      animation_common_1.traceWrite(
        ...
        animation_common_1.traceCategories.Animation,
        animation_common_1.traceType.warn
      );
      return;
    }
    animation_common_1.traceWrite(
      'Cancelling AnimatorSet.',
      animation_common_1.traceCategories.Animation
    );
  ...
  Animation.prototype._play = function() {
    ...
    if (animation_common_1.traceEnabled()) {
      animation_common_1.traceWrite(
        'Starting ' +
          this._nativeAnimatorsArray.length +
          ' animations ' +
          (this._playSequentially ? 'sequentially.' : 'together.'),
        animation_common_1.traceCategories.Animation
      );
    }
  ...
  Animation.prototype._createAnimators = function(propertyAnimation) {
    ...
    if (animation_common_1.traceEnabled()) {
      animation_common_1.traceWrite(
        'Creating ObjectAnimator(s) for animation: ' +
    ...
    if (
      propertyAnimation.target === null ||
      propertyAnimation.target === undefined
    ) {
      throw new Error(
        'Animation target cannot be null or undefined; property: ' +
    ...
    if (
      ...
      propertyAnimation.property === undefined
    ) {
      throw new Error(
        'Animation property cannot be null or undefined; target: ' +
    ...
    if (
      propertyAnimation.value === null ||
      propertyAnimation.value === undefined
    ) {
      throw new Error(
        'Animation value cannot be null or undefined; target: ' +
          propertyAnimation.target +
          '; property: ' +
          propertyAnimation.property +
          ';'
    ...
    switch (propertyAnimation.property) {
      case animation_common_1.Properties.opacity:
        ...
        propertyUpdateCallbacks.push(
          checkAnimation(function() {
            propertyAnimation.target.style[
              setLocal
                ? style_properties_1.opacityProperty.name
                : style_properties_1.opacityProperty.keyframe
            ] = propertyAnimation.value;
          })
        );
        propertyResetCallbacks.push(
          checkAnimation(function() {
            ...
            if (propertyAnimation.target.nativeViewProtected) {
              propertyAnimation.target[
                style_properties_1.opacityProperty.setNative
              ](propertyAnimation.target.style.opacity);
            }
          })
        );
        animators.push(
      ...
      case animation_common_1.Properties.backgroundColor:
        style_properties_1.backgroundColorProperty._initDefaultNativeValue(
          style
        );
        ensureArgbEvaluator();
        originalValue1 = propertyAnimation.target.backgroundColor;
        nativeArray = Array.create(java.lang.Object, 2);
        nativeArray[0] = propertyAnimation.target.backgroundColor
          ? java.lang.Integer.valueOf(
              propertyAnimation.target.backgroundColor.argb
            )
          : java.lang.Integer.valueOf(-1);
        nativeArray[1] = java.lang.Integer.valueOf(
          propertyAnimation.value.argb
        );
        var animator = android.animation.ValueAnimator.ofObject(
          argbEvaluator,
          nativeArray
        );
        animator.addUpdateListener(
          new android.animation.ValueAnimator.AnimatorUpdateListener({
            onAnimationUpdate: function(animator) {
              ...
              propertyAnimation.target.style[
                setLocal
                  ? style_properties_1.backgroundColorProperty.name
                  : style_properties_1.backgroundColorProperty.keyframe
              ] = new animation_common_1.Color(argb);
            }
          })
        );
        propertyUpdateCallbacks.push(
        ...
        propertyResetCallbacks.push(
          checkAnimation(function() {
            ...
            if (
              propertyAnimation.target.nativeViewProtected &&
              propertyAnimation.target[
                style_properties_1.backgroundColorProperty.setNative
              ]
            ) {
              propertyAnimation.target[
                style_properties_1.backgroundColorProperty.setNative
              ](propertyAnimation.target.style.backgroundColor);
            }
          })
        );
      ...
      case animation_common_1.Properties.translate:
        ...
        xyObjectAnimators[0] = android.animation.ObjectAnimator.ofFloat(
          nativeView,
          'translationX',
          nativeArray
        );
        xyObjectAnimators[0].setRepeatCount(
          Animation._getAndroidRepeatCount(propertyAnimation.iterations)
        );
        nativeArray = Array.create('float', 1);
        nativeArray[0] = propertyAnimation.value.y * density;
        xyObjectAnimators[1] = android.animation.ObjectAnimator.ofFloat(
          nativeView,
          'translationY',
          nativeArray
        );
        xyObjectAnimators[1].setRepeatCount(
          Animation._getAndroidRepeatCount(propertyAnimation.iterations)
        );
        ...
        propertyUpdateCallbacks.push(
          checkAnimation(function() {
            propertyAnimation.target.style[
              setLocal
                ? style_properties_1.translateXProperty.name
                : style_properties_1.translateXProperty.keyframe
            ] = propertyAnimation.value.x;
            propertyAnimation.target.style[
              setLocal
                ? style_properties_1.translateYProperty.name
                : style_properties_1.translateYProperty.keyframe
            ] = propertyAnimation.value.y;
          })
        );
        propertyResetCallbacks.push(
          checkAnimation(function() {
            ...
            if (propertyAnimation.target.nativeViewProtected) {
              propertyAnimation.target[
                style_properties_1.translateXProperty.setNative
              ](propertyAnimation.target.style.translateX);
              propertyAnimation.target[
                style_properties_1.translateYProperty.setNative
              ](propertyAnimation.target.style.translateY);
            }
          })
        );
      ...
      case animation_common_1.Properties.scale:
        ...
        propertyUpdateCallbacks.push(
          checkAnimation(function() {
            propertyAnimation.target.style[
              setLocal
                ? style_properties_1.scaleXProperty.name
                : style_properties_1.scaleXProperty.keyframe
            ] = propertyAnimation.value.x;
            propertyAnimation.target.style[
              setLocal
                ? style_properties_1.scaleYProperty.name
                : style_properties_1.scaleYProperty.keyframe
            ] = propertyAnimation.value.y;
          })
        );
        propertyResetCallbacks.push(
          checkAnimation(function() {
            ...
            if (propertyAnimation.target.nativeViewProtected) {
              propertyAnimation.target[
                style_properties_1.scaleXProperty.setNative
              ](propertyAnimation.target.style.scaleX);
              propertyAnimation.target[
                style_properties_1.scaleYProperty.setNative
              ](propertyAnimation.target.style.scaleY);
            }
          })
        );
        animatorSet = new android.animation.AnimatorSet();
      ...
      case animation_common_1.Properties.rotate:
        ...
        propertyUpdateCallbacks.push(
          checkAnimation(function() {
            propertyAnimation.target.style[
              setLocal
                ? style_properties_1.rotateProperty.name
                : style_properties_1.rotateProperty.keyframe
            ] = propertyAnimation.value;
          })
        );
        propertyResetCallbacks.push(
          checkAnimation(function() {
            ...
            if (propertyAnimation.target.nativeViewProtected) {
              propertyAnimation.target[
                style_properties_1.rotateProperty.setNative
              ](propertyAnimation.target.style.rotate);
            }
          })
        );
        animators.push(
      ...
      case animation_common_1.Properties.height: {
        ...
        var extentProperty_1 = isVertical
          ? style_properties_1.heightProperty
          : style_properties_1.widthProperty;
        ...
        if (!parent_1) {
          throw new Error(
            'cannot animate ' + propertyAnimation.property + ' on root view'
          );
        }
        var parentExtent = isVertical
          ? parent_1.getMeasuredHeight()
          : parent_1.getMeasuredWidth();
        toValue =
          style_properties_1.PercentLength.toDevicePixels(
            toValue,
            parentExtent,
            parentExtent
          ) / platform_1.screen.mainScreen.scale;
        var nativeHeight = isVertical
          ? nativeView.getHeight()
          : nativeView.getWidth();
        var targetStyle_1 = setLocal
          ? extentProperty_1.name
          : extentProperty_1.keyframe;
        originalValue1 = nativeHeight / platform_1.screen.mainScreen.scale;
        nativeArray[0] = originalValue1;
        nativeArray[1] = toValue;
        var extentAnimator = android.animation.ValueAnimator.ofFloat(
          nativeArray
        );
        extentAnimator.addUpdateListener(
          new android.animation.ValueAnimator.AnimatorUpdateListener({
            onAnimationUpdate: function(animator) {
              ...
              propertyAnimation.target.style[
                setLocal ? extentProperty_1.name : extentProperty_1.keyframe
              ] = argb;
            }
          })
        );
        propertyUpdateCallbacks.push(
          checkAnimation(function() {
            propertyAnimation.target.style[targetStyle_1] =
              propertyAnimation.value;
          })
        );
        propertyResetCallbacks.push(
          checkAnimation(function() {
            ...
            if (propertyAnimation.target.nativeViewProtected) {
              ...
              setter(
                propertyAnimation.target.style[propertyAnimation.property]
              );
            }
          })
        );
    ...
    for (var i = 0, length_3 = animators.length; i < length_3; i++) {
      ...
      if (
        propertyAnimation.iterations !== undefined &&
        animators[i] instanceof android.animation.ValueAnimator
      ) {
        animators[i].setRepeatCount(
          Animation._getAndroidRepeatCount(propertyAnimation.iterations)
        );
      }
      ...
      if (animation_common_1.traceEnabled()) {
        animation_common_1.traceWrite(
          'Animator created: ' + animators[i],
          animation_common_1.traceCategories.Animation
        );
      }
    }
    this._animators = this._animators.concat(animators);
    this._propertyUpdateCallbacks = this._propertyUpdateCallbacks.concat(
      propertyUpdateCallbacks
    );
    this._propertyResetCallbacks = this._propertyResetCallbacks.concat(
      propertyResetCallbacks
    );
  };
