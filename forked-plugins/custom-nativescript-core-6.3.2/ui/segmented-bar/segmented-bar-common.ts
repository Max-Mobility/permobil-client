import { AddArrayFromBuilder, AddChildFromBuilder, CoercibleProperty, Color, CSSType, EventData, InheritedCssProperty, Property, Style, View, ViewBase } from "../core/view";
import { SegmentedBar as SegmentedBarDefinition, SegmentedBarItem as SegmentedBarItemDefinition, SelectedIndexChangedEventData } from "../segmented-bar";
