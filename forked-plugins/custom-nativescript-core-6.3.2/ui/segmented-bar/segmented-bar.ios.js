...
var SegmentedBar = (function(_super) {
  ...
  SegmentedBar.prototype.initNativeView = function() {
    ...
    this._selectionHandler = SelectionHandlerImpl.initWithOwner(
      new WeakRef(this)
    );
  ...
  SegmentedBar.prototype[
    ...
    if (newItems && newItems.length) {
      newItems.forEach(function(item, index, arr) {
        ...
        title = title === null || title === undefined ? '' : title;
        segmentedControl.insertSegmentWithTitleAtIndexAnimated(
          title,
          index,
          false
        );
  ...
  SegmentedBar.prototype[
    ...
    var currentOsVersion = utils_1.ios.MajorVersion;
    return currentOsVersion < 13
      ? this.ios.tintColor
      : this.ios.selectedSegmentTintColor;
  };
  SegmentedBar.prototype[
    ...
    var currentOsVersion = utils_1.ios.MajorVersion;
    var color =
      value instanceof segmented_bar_common_1.Color ? value.ios : value;
  ...
  SegmentedBar.prototype[
    ...
    var font = value
      ? value.getUIFont(UIFont.systemFontOfSize(UIFont.labelFontSize))
      : null;
    var bar = this.ios;
    var currentAttrs = bar.titleTextAttributesForState(0);
    var attrs = currentAttrs
