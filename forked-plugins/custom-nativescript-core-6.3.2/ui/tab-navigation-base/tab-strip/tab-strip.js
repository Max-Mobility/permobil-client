...
exports.highlightColorProperty = new view_1.Property({
  name: 'highlightColor',
...
var TabStrip = (function(_super) {
  ...
  TabStrip.prototype[view_1.backgroundColorProperty.setNative] = function(
    value
  ) {
    var parent = this.parent;
  ...
  TabStrip.prototype[view_1.backgroundInternalProperty.setNative] = function(
    value
  ) {};
  ...
  TabStrip.prototype[text_base_1.textTransformProperty.setNative] = function(
    value
  ) {
    var parent = this.parent;
  ...
  TabStrip.prototype[exports.highlightColorProperty.setNative] = function(
    value
  ) {
    var parent = this.parent;
  ...
  TabStrip = __decorate([view_1.CSSType('TabStrip')], TabStrip);
  return TabStrip;
})(view_1.View);
