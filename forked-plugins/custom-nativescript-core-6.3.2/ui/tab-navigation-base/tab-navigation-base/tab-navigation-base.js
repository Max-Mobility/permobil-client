...
var tab_content_item_1 = require('../tab-content-item');
var tab_strip_1 = require('../tab-strip');
...
var TabNavigationBase = (function(_super) {
  ...
  TabNavigationBase.prototype._addChildFromBuilder = function(name, value) {
    if (value instanceof tab_content_item_1.TabContentItem) {
      if (!this.items) {
        this.items = new Array();
      }
      this.items.push(value);
      this._addView(value);
    } else if (value instanceof tab_strip_1.TabStrip) {
      this.tabStrip = value;
    }
  };
  ...
  TabNavigationBase.prototype.onTabStripChanged = function(
    oldTabStrip,
    newTabStrip
  ) {
  ...
  TabNavigationBase.prototype.onSelectedIndexChanged = function(
    oldIndex,
    newIndex
  ) {
    this.notify({
  ...
  TabNavigationBase.prototype.setTabBarItemTitle = function(
    tabStripItem,
    value
  ) {};
  TabNavigationBase.prototype.getTabBarItemBackgroundColor = function(
    tabStripItem
  ) {
    return null;
  };
  TabNavigationBase.prototype.setTabBarItemBackgroundColor = function(
    tabStripItem,
    value
  ) {};
  ...
  TabNavigationBase.prototype.setTabBarItemColor = function(
    tabStripItem,
    value
  ) {};
  TabNavigationBase.prototype.setTabBarIconColor = function(
    tabStripItem,
    value
  ) {};
  ...
  TabNavigationBase.prototype.setTabBarItemFontSize = function(
    tabStripItem,
    value
  ) {};
  TabNavigationBase.prototype.getTabBarItemFontInternal = function(
    tabStripItem
  ) {
    return null;
  };
  TabNavigationBase.prototype.setTabBarItemFontInternal = function(
    tabStripItem,
    value
  ) {};
  TabNavigationBase.prototype.getTabBarItemTextTransform = function(
    tabStripItem
  ) {
    return null;
  };
  TabNavigationBase.prototype.setTabBarItemTextTransform = function(
    tabStripItem,
    value
  ) {};
