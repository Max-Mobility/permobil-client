...
import { ActionOptions, ConfirmOptions, DialogOptions, LoginOptions, LoginResult, PromptOptions, PromptResult } from "../dialogs";
import { ALERT, CANCEL, capitalizationType, CONFIRM, getButtonColors, getLabelColor, inputType, isDialogOptions, OK, parseLoginOptions, PROMPT } from "./dialogs-common";
