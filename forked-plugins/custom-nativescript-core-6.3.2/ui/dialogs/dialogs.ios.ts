...
import { isDefined, isFunction, isString } from "../../utils/types";
import { ios as iosView } from "../core/view";
import { ActionOptions, ConfirmOptions, LoginOptions, LoginResult, PromptOptions, PromptResult } from "../dialogs";
import { ALERT, CANCEL, capitalizationType, CONFIRM, getButtonColors, getCurrentPage, getLabelColor, getTextFieldColor, inputType, isDialogOptions, OK, parseLoginOptions, PROMPT } from "./dialogs-common";
