...
(function(AndroidTransitionType) {
  ...
  (AndroidTransitionType =
    exports.AndroidTransitionType || (exports.AndroidTransitionType = {}))
);
var transitionId = 0;
var Transition = (function() {
  function Transition(duration, curve) {
    this._duration = duration;
    this._interpolator = curve
      ? animation_1._resolveAnimationCurve(curve)
      : _defaultInterpolator();
  ...
  Transition.prototype.animateIOSTransition = function(
    containerView,
    fromView,
    toView,
    operation,
