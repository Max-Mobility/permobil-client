...
var Page = (function(_super) {
  ...
  Page.prototype._addViewToNativeVisualTree = function(child, atIndex) {
    ...
    return _super.prototype._addViewToNativeVisualTree.call(
      this,
      child,
      atIndex
    );
  ...
  Page.prototype[
    page_common_1.androidStatusBarBackgroundProperty.getDefault
  ] = function() {
    if (platform_1.device.sdkVersion >= '21') {
  ...
  Page.prototype[
    page_common_1.androidStatusBarBackgroundProperty.setNative
  ] = function(value) {
    if (platform_1.device.sdkVersion >= '21') {
