...
var Button = (function(_super) {
  ...
  Button.prototype[button_common_1.paddingTopProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setPaddingTop(
      ...
      button_common_1.Length.toDevicePixels(value, 0) +
        button_common_1.Length.toDevicePixels(this.style.borderTopWidth, 0)
    );
  };
  Button.prototype[
  ...
  Button.prototype[button_common_1.paddingRightProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setPaddingRight(
      this.nativeViewProtected,
      button_common_1.Length.toDevicePixels(value, 0) +
        button_common_1.Length.toDevicePixels(this.style.borderRightWidth, 0)
    );
  };
  Button.prototype[
  ...
  Button.prototype[button_common_1.paddingBottomProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setPaddingBottom(
      this.nativeViewProtected,
      button_common_1.Length.toDevicePixels(value, 0) +
        button_common_1.Length.toDevicePixels(this.style.borderBottomWidth, 0)
    );
  };
  Button.prototype[
  ...
  Button.prototype[button_common_1.paddingLeftProperty.setNative] = function(
    ...
    org.nativescript.widgets.ViewHelper.setPaddingLeft(
      this.nativeViewProtected,
      button_common_1.Length.toDevicePixels(value, 0) +
        button_common_1.Length.toDevicePixels(this.style.borderLeftWidth, 0)
    );
  };
  ...
  Button.prototype[button_common_1.textAlignmentProperty.setNative] = function(
    ...
    _super.prototype[button_common_1.textAlignmentProperty.setNative].call(
      this,
      newValue
    );
  };
