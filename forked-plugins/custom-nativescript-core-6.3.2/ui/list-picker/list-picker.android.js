...
function initializeNativeClasses() {
  ...
  var ValueChangeListenerImpl = (function(_super) {
    ...
    ValueChangeListenerImpl.prototype.onValueChange = function(
      picker,
      oldValue,
      newValue
    ) {
      list_picker_common_1.selectedIndexProperty.nativeValueChange(
        this.owner,
        newValue
      );
...
function getSelectorWheelPaint(picker) {
  if (!selectorWheelPaintField) {
    selectorWheelPaintField = picker
      .getClass()
...
var ListPicker = (function(_super) {
  ...
  ListPicker.prototype.createNativeView = function() {
    ...
    picker.setDescendantFocusability(
  ...
  ListPicker.prototype[list_picker_common_1.colorProperty.setNative] = function(
    ...
    var color =
      value instanceof list_picker_common_1.Color ? value.android : value;
    if (this._selectorWheelPaint) {
