import { AutocapitalizationType, EditableTextBase as EditableTextBaseDefinition, KeyboardType, ReturnKeyType, UpdateTextTrigger } from "../editable-text-base";
import { booleanConverter, Color, CssProperty, makeParser, makeValidator, Property, PseudoClassHandler, Style, TextBase } from "../text-base";
