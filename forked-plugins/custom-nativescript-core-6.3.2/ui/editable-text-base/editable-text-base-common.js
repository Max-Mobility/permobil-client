...
var EditableTextBase = (function(_super) {
  ...
  function EditableTextBase() {
    ...
    _this._focusHandler = function() {
      return _this._goToVisualState('focus');
    };
    _this._blurHandler = function() {
      return _this._goToVisualState('blur');
    };
    return _this;
  }
  EditableTextBase.prototype._updateTextBaseFocusStateHandler = function(
    subscribe
  ) {
  ...
  __decorate(
    ...
    '_updateTextBaseFocusStateHandler',
    null
  );
...
var keyboardTypeConverter = text_base_1.makeParser(
  text_base_1.makeValidator('datetime', 'phone', 'number', 'url', 'email')
);
...
var returnKeyTypeConverter = text_base_1.makeParser(
  text_base_1.makeValidator('done', 'next', 'go', 'search', 'send')
);
...
var autocapitalizationTypeConverter = text_base_1.makeParser(
  text_base_1.makeValidator('none', 'words', 'sentences', 'allcharacters')
);
