  ...
  var WebViewClientImpl = (function(_super) {
    ...
    WebViewClientImpl.prototype.shouldOverrideUrlLoading = function(view, url) {
      if (web_view_common_1.traceEnabled()) {
        web_view_common_1.traceWrite(
          'WebViewClientClass.shouldOverrideUrlLoading(' + url + ')',
    ...
    WebViewClientImpl.prototype.onPageStarted = function(view, url, favicon) {
      ...
      if (owner) {
        if (web_view_common_1.traceEnabled()) {
          web_view_common_1.traceWrite(
            'WebViewClientClass.onPageStarted(' + url + ', ' + favicon + ')',
            web_view_common_1.traceCategories.Debug
          );
        }
    ...
    WebViewClientImpl.prototype.onPageFinished = function(view, url) {
      ...
      if (owner) {
        if (web_view_common_1.traceEnabled()) {
          web_view_common_1.traceWrite(
            'WebViewClientClass.onPageFinished(' + url + ')',
            web_view_common_1.traceCategories.Debug
          );
        }
    ...
    WebViewClientImpl.prototype.onReceivedError = function() {
      ...
      if (arguments.length === 4) {
        ...
        _super.prototype.onReceivedError.call(
          this,
          view,
          errorCode,
          description,
        ...
        if (owner) {
          if (web_view_common_1.traceEnabled()) {
            web_view_common_1.traceWrite(
              'WebViewClientClass.onReceivedError(' +
                errorCode +
                ', ' +
                description +
                ', ' +
