...
var WKNavigationDelegateImpl = (function(_super) {
  ...
  WKNavigationDelegateImpl.prototype.webViewDecidePolicyForNavigationActionDecisionHandler = function(
    webView,
    navigationAction,
    decisionHandler
  ) {
    ...
    if (owner && navigationAction.request.URL) {
      ...
      if (web_view_common_1.traceEnabled()) {
        web_view_common_1.traceWrite(
          'WKNavigationDelegateClass.webViewDecidePolicyForNavigationActionDecisionHandler(' +
            navigationAction.request.URL.absoluteString +
            ', ' +
            navigationAction.navigationType +
            ')',
          web_view_common_1.traceCategories.Debug
        );
      }
  ...
  WKNavigationDelegateImpl.prototype.webViewDidStartProvisionalNavigation = function(
    webView,
    navigation
  ) {
    if (web_view_common_1.traceEnabled()) {
      web_view_common_1.traceWrite(
        'WKNavigationDelegateClass.webViewDidStartProvisionalNavigation(' +
          webView.URL +
          ')',
        web_view_common_1.traceCategories.Debug
      );
  ...
  WKNavigationDelegateImpl.prototype.webViewDidFinishNavigation = function(
    webView,
    navigation
  ) {
    if (web_view_common_1.traceEnabled()) {
      web_view_common_1.traceWrite(
        'WKNavigationDelegateClass.webViewDidFinishNavigation(' +
          webView.URL +
          ')',
        web_view_common_1.traceCategories.Debug
      );
  ...
  WKNavigationDelegateImpl.prototype.webViewDidFailNavigationWithError = function(
    webView,
    navigation,
    error
  ) {
    ...
    if (owner) {
      ...
      if (web_view_common_1.traceEnabled()) {
        web_view_common_1.traceWrite(
          'WKNavigationDelegateClass.webViewDidFailNavigationWithError(' +
  ...
  WKNavigationDelegateImpl.prototype.webViewDidFailProvisionalNavigationWithError = function(
    webView,
    navigation,
    error
  ) {
    ...
    if (owner) {
      ...
      if (web_view_common_1.traceEnabled()) {
        web_view_common_1.traceWrite(
          'WKNavigationDelegateClass.webViewDidFailProvisionalNavigationWithError(' +
            error.localizedDescription +
            ')',
          web_view_common_1.traceCategories.Debug
        );
...
var WebView = (function(_super) {
  ...
  WebView.prototype.createNativeView = function() {
    ...
    var wkUScript = WKUserScript.alloc().initWithSourceInjectionTimeForMainFrameOnly(
      jScript,
      1,
      true
    );
  ...
  WebView.prototype._loadUrl = function(src) {
    if (src.startsWith('file:///')) {
      ...
      this.ios.loadFileURLAllowingReadAccessToURL(
        NSURL.URLWithString(src),
        NSURL.URLWithString(cachePath)
      );
    } else {
      this.ios.loadRequest(
        NSURLRequest.requestWithURL(NSURL.URLWithString(src))
      );
    }
  };
  WebView.prototype._loadData = function(content) {
    this.ios.loadHTMLStringBaseURL(
      content,
      NSURL.alloc().initWithString(
        'file:///' + web_view_common_1.knownFolders.currentApp().path + '/'
      )
    );
  };
