...
var UIGestureRecognizerDelegateImpl = (function(_super) {
  ...
  UIGestureRecognizerDelegateImpl.prototype.gestureRecognizerShouldRecognizeSimultaneouslyWithGestureRecognizer = function(
    gestureRecognizer,
    otherGestureRecognizer
  ) {
    return true;
  };
  UIGestureRecognizerDelegateImpl.prototype.gestureRecognizerShouldRequireFailureOfGestureRecognizer = function(
    gestureRecognizer,
    otherGestureRecognizer
  ) {
    if (
...
var UIGestureRecognizerImpl = (function(_super) {
  ...
  UIGestureRecognizerImpl.initWithOwnerTypeCallback = function(
    owner,
    type,
    callback,
    thisArg
...
var GesturesObserver = (function(_super) {
    ...
    if (
      ...
      if (type & gestures_common_1.GestureTypes.tap) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(gestures_common_1.GestureTypes.tap)
        );
      }
      if (type & gestures_common_1.GestureTypes.doubleTap) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(gestures_common_1.GestureTypes.doubleTap)
        );
      }
      if (type & gestures_common_1.GestureTypes.pinch) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(gestures_common_1.GestureTypes.pinch, function(
            args
          ) {
      ...
      if (type & gestures_common_1.GestureTypes.pan) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(gestures_common_1.GestureTypes.pan, function(
            args
          ) {
            _this._executeCallback(
      ...
      if (type & gestures_common_1.GestureTypes.swipe) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(
            gestures_common_1.GestureTypes.swipe,
            function(args) {
      ...
      if (type & gestures_common_1.GestureTypes.longPress) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(gestures_common_1.GestureTypes.longPress)
        );
      }
      if (type & gestures_common_1.GestureTypes.touch) {
        nativeView.addGestureRecognizer(
          this._createRecognizer(gestures_common_1.GestureTypes.touch)
        );
      }
    }
  };
    ...
    if (this.target && this.target.nativeViewProtected) {
      for (var name_1 in this._recognizers) {
        if (this._recognizers.hasOwnProperty(name_1)) {
          ...
          this.target.nativeViewProtected.removeGestureRecognizer(
            item.recognizer
          );
  ...
  GesturesObserver.prototype._createRecognizer = function(
    type,
    callback,
    swipeDirection
  ) {
    ...
    var target = _createUIGestureRecognizerTarget(
      this,
      type,
      callback,
      this.context
    ...
    if (recognizerType) {
      recognizer = recognizerType
        .alloc()
        .initWithTargetAction(target, 'recognize');
...
function _createUIGestureRecognizerTarget(owner, type, callback, context) {
  return UIGestureRecognizerImpl.initWithOwnerTypeCallback(
    new WeakRef(owner),
    type,
    callback,
    context
...
var TouchGestureRecognizer = (function(_super) {
  ...
  TouchGestureRecognizer.prototype.touchesBeganWithEvent = function(
    touches,
    event
  ) {
  ...
  TouchGestureRecognizer.prototype.touchesMovedWithEvent = function(
    touches,
    event
  ) {
  ...
  TouchGestureRecognizer.prototype.touchesEndedWithEvent = function(
    touches,
    event
  ) {
  ...
  TouchGestureRecognizer.prototype.touchesCancelledWithEvent = function(
    touches,
    event
  ) {
  ...
  TouchGestureRecognizer.prototype.executeCallback = function(
    action,
    touches,
    event
  ) {
...
var Pointer = (function() {
  ...
  Object.defineProperty(Pointer.prototype, 'location', {
    get: function() {
      if (!this._location) {
        this._location = this.ios.locationInView(
...
var TouchGestureEventData = (function() {
  ...
  TouchGestureEventData.prototype.prepare = function(
    view,
    action,
    touches,
    event
  ...
  TouchGestureEventData.prototype.getActivePointers = function() {
    if (!this._activePointers) {
      ...
      for (
        var i = 0, nsArr = this.ios.touches.allObjects;
        i < nsArr.count;
        i++
      ) {
        this._activePointers.push(
          new Pointer(nsArr.objectAtIndex(i), this.view)
        );
      }
    }
