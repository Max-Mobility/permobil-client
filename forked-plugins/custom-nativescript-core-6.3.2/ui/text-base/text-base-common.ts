...
import { CssProperty, InheritedCssProperty, isAndroid, isIOS, Length, makeParser, makeValidator, Observable, Property, Style, View, ViewBase } from "../core/view";
import { FontStyle, FontWeight } from "../styling/font-interfaces";
import { TextBase as TextBaseDefinition } from "../text-base";
// Requires.
