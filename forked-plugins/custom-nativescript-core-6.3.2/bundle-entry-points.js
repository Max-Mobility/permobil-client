if (global.TNS_WEBPACK) {
  ...
  global.registerModule('text/formatted-string', function() {
    return require('./text/formatted-string');
  });
  global.registerModule('text/span', function() {
    return require('./text/span');
  });
  global.registerModule('ui/text-base/formatted-string', function() {
    return require('./ui/text-base/formatted-string');
  });
  global.registerModule('ui/text-base/span', function() {
    return require('./ui/text-base/span');
  });
  global.registerModule('ui/action-bar', function() {
    return require('./ui/action-bar');
  });
  global.registerModule('ui/activity-indicator', function() {
    return require('./ui/activity-indicator');
  });
  global.registerModule('ui/border', function() {
    return require('./ui/border');
  });
  global.registerModule('ui/bottom-navigation', function() {
    return require('./ui/bottom-navigation');
  });
  global.registerModule('ui/button', function() {
    return require('./ui/button');
  });
  global.registerModule('ui/content-view', function() {
    return require('./ui/content-view');
  });
  global.registerModule('ui/date-picker', function() {
    return require('./ui/date-picker');
  });
  global.registerModule('ui/frame', function() {
    return require('./ui/frame');
  });
  global.registerModule('ui/html-view', function() {
    return require('./ui/html-view');
  });
  ...
  global.registerModule('ui/tab-view', function() {
    return require('./ui/tab-view');
  });
  global.registerModule('ui/tab-navigation-base/tab-strip', function() {
    return require('./ui/tab-navigation-base/tab-strip');
  });
  global.registerModule('ui/tab-navigation-base/tab-strip-item', function() {
    return require('./ui/tab-navigation-base/tab-strip-item');
  });
  global.registerModule('ui/tab-navigation-base/tab-content-item', function() {
    return require('./ui/tab-navigation-base/tab-content-item');
  });
  global.registerModule('ui/tabs', function() {
    return require('./ui/tabs');
  });
  global.registerModule('ui/web-view', function() {
    return require('./ui/web-view');
  });
  global.registerModule('ui/text-field', function() {
    return require('./ui/text-field');
  });
  global.registerModule('ui/text-view', function() {
    return require('./ui/text-view');
  });
  global.registerModule('ui/time-picker', function() {
    return require('./ui/time-picker');
  });
  global.registerModule('ui/list-view', function() {
    return require('./ui/list-view');
  });
}
