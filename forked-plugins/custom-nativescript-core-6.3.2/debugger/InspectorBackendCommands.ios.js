...
function DomainDispatcher(domain) {
  return function(klass) {
    return __registerDomainDispatcher(domain, klass);
  };
}
    ...
    HeapFrontend.prototype.trackingStart = function(timestamp, snapshotData) {
      __inspectorSendEvent(
        JSON.stringify({
          ...
          params: { timestamp: timestamp, snapshotData: snapshotData }
        })
      );
    };
    HeapFrontend.prototype.trackingComplete = function(
      timestamp,
      snapshotData
    ) {
      __inspectorSendEvent(
...
(function(DebuggerDomain) {
  var DebuggerFrontend = (function() {
    ...
    DebuggerFrontend.prototype.globalObjectCleared = function() {
      __inspectorSendEvent(
        JSON.stringify({ method: 'Debugger.globalObjectCleared', params: {} })
      );
    };
    DebuggerFrontend.prototype.scriptParsed = function(
      scriptId,
      url,
      startLine,
      startColumn,
    ...
    DebuggerFrontend.prototype.scriptFailedToParse = function(
      url,
      scriptSource,
      startLine,
      errorLine,
    ...
    DebuggerFrontend.prototype.breakpointResolved = function(
      breakpointId,
      location
    ) {
      __inspectorSendEvent(
    ...
    DebuggerFrontend.prototype.paused = function(callFrames, reason, data) {
      __inspectorSendEvent(
        JSON.stringify({
          ...
          params: { callFrames: callFrames, reason: reason, data: data }
        })
      );
    };
    DebuggerFrontend.prototype.resumed = function() {
      __inspectorSendEvent(
        JSON.stringify({ method: 'Debugger.resumed', params: {} })
      );
    };
    ...
    DebuggerFrontend.prototype.playBreakpointActionSound = function(
      breakpointActionId
    ) {
      __inspectorSendEvent(
        JSON.stringify({
...
(function(ConsoleDomain) {
  var ConsoleFrontend = (function() {
    ...
    ConsoleFrontend.prototype.heapSnapshot = function(
      timestamp,
      snapshotData,
      title
    ) {
...
(function(PageDomain) {
  var PageFrontend = (function() {
    ...
    PageFrontend.prototype.javascriptDialogClosed = function() {
      __inspectorSendEvent(
        JSON.stringify({ method: 'Page.javascriptDialogClosed', params: {} })
      );
    };
...
(function(NetworkDomain) {
  var NetworkFrontend = (function() {
    ...
    NetworkFrontend.prototype.requestWillBeSent = function(
      requestId,
      frameId,
      loaderId,
      documentURL,
    ...
    NetworkFrontend.prototype.responseReceived = function(
      requestId,
      frameId,
      loaderId,
      timestamp,
    ...
    NetworkFrontend.prototype.dataReceived = function(
      requestId,
      timestamp,
      dataLength,
      encodedDataLength
    ...
    NetworkFrontend.prototype.loadingFinished = function(
      requestId,
      timestamp,
      sourceMapURL
    ) {
    ...
    NetworkFrontend.prototype.loadingFailed = function(
      requestId,
      timestamp,
      errorText,
      canceled
    ...
    NetworkFrontend.prototype.requestServedFromMemoryCache = function(
      requestId,
      frameId,
      loaderId,
      documentURL,
    ...
    NetworkFrontend.prototype.webSocketWillSendHandshakeRequest = function(
      requestId,
      timestamp,
      request
    ) {
    ...
    NetworkFrontend.prototype.webSocketHandshakeResponseReceived = function(
      requestId,
      timestamp,
      response
    ) {
    ...
    NetworkFrontend.prototype.webSocketFrameReceived = function(
      requestId,
      timestamp,
      response
    ) {
    ...
    NetworkFrontend.prototype.webSocketFrameError = function(
      requestId,
      timestamp,
      errorMessage
    ) {
    ...
    NetworkFrontend.prototype.webSocketFrameSent = function(
      requestId,
      timestamp,
      response
    ) {
...
(function(DOMDomain) {
  var DOMFrontend = (function() {
    ...
    DOMFrontend.prototype.documentUpdated = function() {
      __inspectorSendEvent(
        JSON.stringify({ method: 'DOM.documentUpdated', params: {} })
      );
    };
    ...
    DOMFrontend.prototype.characterDataModified = function(
      nodeId,
      characterData
    ) {
      __inspectorSendEvent(
    ...
    DOMFrontend.prototype.childNodeCountUpdated = function(
      nodeId,
      childNodeCount
    ) {
      __inspectorSendEvent(
    ...
    DOMFrontend.prototype.childNodeInserted = function(
      parentNodeId,
      previousNodeId,
      node
    ) {
    ...
    DOMFrontend.prototype.pseudoElementAdded = function(
      parentId,
      pseudoElement
    ) {
      __inspectorSendEvent(
        JSON.stringify({
          ...
          params: { parentId: parentId, pseudoElement: pseudoElement }
        })
      );
    };
    DOMFrontend.prototype.pseudoElementRemoved = function(
      parentId,
      pseudoElementId
    ) {
      __inspectorSendEvent(
        JSON.stringify({
          ...
          params: { parentId: parentId, pseudoElementId: pseudoElementId }
        })
      );
    };
    return DOMFrontend;
...
(function(CSSDomain) {
  var CSSFrontend = (function() {
    ...
    CSSFrontend.prototype.mediaQueryResultChanged = function() {
      __inspectorSendEvent(
        JSON.stringify({ method: 'CSS.mediaQueryResultChanged', params: {} })
      );
    };
    CSSFrontend.prototype.fontsUpdated = function() {
      __inspectorSendEvent(
        JSON.stringify({ method: 'CSS.fontsUpdated', params: {} })
      );
    };
    ...
    CSSFrontend.prototype.layoutEditorChange = function(
      styleSheetId,
      changeRange
    ) {
      __inspectorSendEvent(
        JSON.stringify({
          ...
          params: { styleSheetId: styleSheetId, changeRange: changeRange }
        })
      );
    };
    return CSSFrontend;
