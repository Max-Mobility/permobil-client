...
var percentLengthToStringLazy = lazy(function() {
  return require('../ui/styling/style-properties')
    .PercentLength.convertToString;
});
var getSetPropertiesLazy = lazy(function() {
  return require('../ui/core/properties').getSetProperties;
});
var getComputedCssValuesLazy = lazy(function() {
  return require('../ui/core/properties').getComputedCssValues;
});
...
var DOMNode = (function() {
  function DOMNode(view) {
    ...
    this.nodeType =
      view.typeName === 'Frame' ? ROOT_NODE_TYPE : ELEMENT_NODE_TYPE;
