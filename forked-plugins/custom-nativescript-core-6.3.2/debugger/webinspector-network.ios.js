...
var Request = (function() {
  ...
  Object.defineProperty(Request.prototype, 'hasTextContent', {
    get: function() {
      return (
        ['Document', 'Stylesheet', 'Script', 'XHR'].indexOf(
          this._resourceType
        ) !== -1
      );
    },
  ...
  Request.prototype.responseReceived = function(response) {
    if (this._networkDomainDebugger.enabled) {
      this._networkDomainDebugger.events.responseReceived(
        this.requestID,
        frameId,
        loaderId,
  ...
  Request.prototype.loadingFinished = function() {
    if (this._networkDomainDebugger.enabled) {
      this._networkDomainDebugger.events.loadingFinished(
        this.requestID,
        __inspectorTimestamp()
      );
    }
  ...
  Request.prototype.requestWillBeSent = function(request) {
    if (this._networkDomainDebugger.enabled) {
      this._networkDomainDebugger.events.requestWillBeSent(
        this.requestID,
        frameId,
        loaderId,
        request.url,
...
var NetworkDomainDebugger = (function() {
  ...
  NetworkDomainDebugger.prototype.getResponseBody = function(params) {
    ...
    var body = resource_data.hasTextContent
      ? NSString.alloc()
          .initWithDataEncoding(resource_data.data, 4)
          .toString()
  ...
  NetworkDomainDebugger.prototype.loadResource = function(params) {
    ...
    var data = fileManager.fileExistsAtPath(pathUrl)
      ? fileManager.contentsAtPath(pathUrl)
      : undefined;
    var content = data
