...
var getAppRootView = function() {
  return require('../application').getRootView();
};
var unsetValue;
...
exports.setAttributeAsText = utils_1.mainThreadify(function setAttributeAsText(
  nodeId,
  text,
  name
) {
