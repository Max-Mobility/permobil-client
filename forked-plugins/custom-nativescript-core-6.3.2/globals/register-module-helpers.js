...
global.registerWebpackModules = function registerWebpackModules(
  context,
  extensionMap
) {
  ...
  context.keys().forEach(function(moduleId) {
    ...
    var registerExt =
      extensionMap[originalExt] ||
      defaultExtensionMap[originalExt] ||
      originalExt;
    ...
    if (registerName.startsWith('./') && registerName.endsWith('.js')) {
      ...
      var moduleNickNames = [registerName.substr(2)];
