...
EMSCRIPTEN_BINDINGS(packet_bindings)
{
  ...
  emscripten::value_object<Packet::TimeInfo>("TimeInfo")
    .field("year", &Packet::TimeInfo::year)
    .field("month", &Packet::TimeInfo::month)
    .field("day", &Packet::TimeInfo::day)
    .field("hours", &Packet::TimeInfo::hours)
    .field("minutes", &Packet::TimeInfo::minutes)
    .field("seconds", &Packet::TimeInfo::seconds);

  emscripten::value_object<Packet::ErrorInfo>("ErrorInfo")
      .field("year", &Packet::ErrorInfo::year)
      .field("month", &Packet::ErrorInfo::month)
      .field("day", &Packet::ErrorInfo::day)
      .field("hour", &Packet::ErrorInfo::hour)
      .field("minute", &Packet::ErrorInfo::minute)
      .field("second", &Packet::ErrorInfo::second)
